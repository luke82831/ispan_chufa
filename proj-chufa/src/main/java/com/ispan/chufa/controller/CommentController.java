...
public class CommentController {
    ...
    // commentService.findById(requestJson.getInt(parentId));
    // // 要驗證資料庫是否有這筆上層留言ID
    // if (parentBean != null) {
    ...
    // commentService.findById(requestJson.getInt(commentId));
    // if (commentBean != null) {
    // responseJson.put(commentId, commentBean.getCommentId())
    // .put(postId, commentBean.getPostId())
    // .put(commentState, commentBean.getCommentState())
    ...
    // if (!requestJson.isNull(content)) {
    // CommentBean commentBean =
    // commentService.updateComment(requestJson.getInt(commentId),
