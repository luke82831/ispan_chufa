...
('USER', 'user1', 0x616263646566, '0912345678', 'user1@example.com', 'User One', 'Male', 'U1', 'Hello, I am User One.', '1990-01-01'),
...
VALUES
(1, 1, 1, '08:00:00', 120, '早上抵達，安排參觀地方A的景點。'),
(1, 2, 2, '10:30:00', 90, '參觀地點B，包含一小時的導覽。'),
(1, 3, 3, '13:00:00', 150, '午餐和休息時間，安排在地點C的餐廳。');
Go