  ...
  <div class="postBox">
    <div class="postBody">
      ...
      <div class="memberPost">
        <img
          @click="inBlogprofile"
          v-if="memberPicture != null"
          :src="'data:image/jpeg;base64,' + memberPicture"
          class="memberPicture"
        />
        <img
          @click="inBlogprofile"
        ...
        <!-- Post作者 -->
        <p class="postTime">
          <strong>發布時間:</strong>{{ postData.postTime }}
        </p>
      ...
      <div v-if="schedule != null && openSchedule" class="schedule">
        ...
        <div class="scheduleEvents">
          ...
          <div
            v-if="hasEvent != []"
            v-for="(eventData, index) in hasEvent[0]"
            class="postPlaceBody"
          >
            <div class="eventTimeBox">
              ...
              <div v-else>
                ...
                <h2>
                  {{
                    addTime(
                      hasEvent[0][index - 1].travelTime,
                      eventData.stayDuration
                    )
                  }}
                </h2>
              </div>
      ...
      <p v-if="postData.postLink != null">
        連結：<a :href="postData.postLink" target="_blank">{{
          postData.postLink
        }}</a>
      </p>
